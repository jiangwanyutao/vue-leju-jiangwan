...
export default {
    ...
    data() {
        return {
            ...
            numData: {
                saleNum: 22010284, // 电商数据的 销售量(假数据)
...
.dashboard_wrapper {
  ...
  .dashboard-main {
    ...
    .content-wrapper {
      ...
      .top-main {
        ...
        .title {
          margin: 0 auto;
          background: url('~@/icons/svg/titleBG.png');
  ...
  background-image: linear-gradient(to right, #24cbff , #8a0dff);
}
}
</style>
